...
// Generated: 5/30/2017 7:00:14 AM by KWhite
// Generated from SmartClient version SNAPSHOT_v11.1d_2017-05-30
...
declare namespace Isc {
	...
	export interface RelativeDate {
		 ...
		 * Flags: IR
		 */
		readonly value?: string | RelativeDateShortcut /* RelativeDateString or RelativeDateShortcut */;
	} // RelativeDate
	...
	export interface DSRequestModifier {
		...
		/** 
		 * (Read only) The value to assign to the field named by DSRequestModifier.fieldName. This value can be static, and 
		 ...
		 * standard velocitySupport','Velocity context variables provided by SmartClient 
	...
	export interface Hilite {
		 ...
		 * Flags: IR, Group: hiliting
		 */
		readonly criteria?: Criteria | AdvancedCriteria /* Criteria or AdvancedCriteria */;
		/** 
		 ...
		 * Flags: IR, Group: hiliting
		 */
		readonly fieldName?: string /* identifier */;
		/** 
	...
	export interface MenuItem extends ListGridRecord {
		 ...
		 */
		readonly keys?: Array<string> /* KeyIdentifier | Array of KeyIdentifer */;
		/** 
	...
	export interface NavigationBarViewState {
		 ...
		 * Flags: IRW
		 */
		readonly controls?: Array<string> /* Array of string or canvas */;
		/** 
	...
	export interface ListGridField {
		 ...
		 * Flags: IR
		 */
		readonly includeInRecordSummaryFields?: Array<string> /* array of fieldNames */;
		/** 
		...
		/** 
		 * (Read only) Name of this field. Must be unique within this ListGrid as well as a valid JavaScript identifier,
		 * as specified by ECMA-262 Section 7.6 (the String.isValidID
		 ...
		 * Flags: IR
		 */
		readonly summaryFunction?: Array<SummaryFunction> /* SummaryFunction  or Array of SummaryFunction */;
		/** 
		 ...
		 * Flags: IRW, Group: display_values
		 */
		readonly valueMap?: Array<string> /* Object | Array of String */;
		/** 
		 ...
		 * Flags: IRW, Group: appearance
		 */
		readonly width?: number | string /* Number or String */;
		/** 
	...
	export interface TreeNode {
		 ...
		 * Flags: IR
		 */
		readonly id?: string | number /* String or Number */;
		/** 
		 ...
		 * Flags: IR
		 */
		readonly isFolder?: boolean | string /* Boolean or String */;
		/** 
		 ...
		 * Flags: IR
		 */
		readonly parentId?: string | number /* String or Number */;
		/** 
	...
	export interface StretchItem {
		 ...
		 * Flags: IR
		 */
		readonly height?: number | string /* number or String */;
		/** 
	...
	export interface Tab {
		 ...
		 * Flags: IRW
		 */
		readonly pane?: string | Canvas /* ID or Canvas */;
		/** 
