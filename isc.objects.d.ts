...
declare namespace Isc {
	...
	export interface AnimateShowEffect  {
		 ...
		 * Flags: IR */
		readonly endsAt?: string; // Flags=IR
		 ...
		 * Flags: IR */
		readonly startFrom?: string; // Flags=IR
		/** (Read only) Effect to apply
		 * Flags: IR */
		readonly effect?: string /* animateShowEffectId */; // Flags=IR
	}
	...
	export interface DSRequestModifier  {
		 ...
		 * Flags: IR */
		readonly fieldName?: string /* String */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly operator?: string /* String */; // Flags=IR
		...
		readonly start?: string /* String */; // Flags=IR
		 ...
		 * Flags: IR, Group: transactionChaining */
		readonly end?: string /* String */; // Flags=IR
		 ...
		 * Flags: IR, Group: transactionChaining */
		readonly value?: string /* String */; // Flags=IR
	}
	...
	export interface Hilite  {
		...
		readonly fieldName?: string /* identifier */; // Flags=IR
		 ...
		 * Flags: IR, Group: hiliting */
		readonly canEdit?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR, Group: hiliting */
		readonly htmlBefore?: string /* HTML */; // Flags=IR
		/** (Read only) Criteria defining what records this hilite should apply to.
		 * Flags: IR, Group: hiliting */
		readonly criteria?: Criteria | AdvancedCriteria /* Criteria or AdvancedCriteria */; // Flags=IR
	}
	...
	export interface EditNode  extends PaletteNode {
		 ...
		 * Flags: IR */
		readonly liveObject?: any /* Object */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly editProxyProperties?: EditProxyProps /* EditProxy Properties */; // Flags=IR
		/** (Read only) SCClassName of the EditNode.liveObject , for example, "ListGrid".
		 * Flags: IR */
		readonly type?: string /* SCClassName */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly defaults?: Properties; // Flags=IR
	}
	...
	export interface SectionStackSection  {
		 ...
		 * Flags: I */
		readonly resizeable?: boolean; // Flags=I
		 ...
		 * Flags: I */
		readonly hidden?: boolean; // Flags=I
		 ...
		 * Flags: I */
		readonly expanded?: boolean; // Flags=I
		 ...
		 * Flags: IR */
		readonly name?: string /* String */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly controls?: Array<Canvas> /* Array of Canvas */; // Flags=IR
		/** (Read only) Title to show for the section
		 * Flags: IR */
		readonly title?: string /* HTMLString */; // Flags=IR
	...
	export interface KeyIdentifier  {
		 ...
		 * Flags: IR */
		readonly shiftKey?: boolean /* Boolean */; // Flags=IR
		/** (Read only) Name of the key.
		 * Flags: IR */
		readonly keyName?: KeyName; // Flags=IR
		/** (Read only) If set, whether the Alt key must be held down.
		 * Flags: IR */
		readonly altKey?: boolean /* Boolean */; // Flags=IR
		/** (Read only) If set, whether the Control key must be held down.
		 * Flags: IR */
		readonly ctrlKey?: boolean /* Boolean */; // Flags=IR
	}
	...
	export interface MenuItem  extends ListGridRecord {
		...
		readonly embeddedComponentFields?: Array<string> /* Array of String */; // Flags=IR
		...
		readonly disabledIcon?: string; // Flags=IR
		 ...
		 * Flags: IR, Group: menuIcons */
		readonly checked?: boolean; // Flags=IR
		...
		readonly keyTitle?: string; // Flags=IR
		 ...
		 * Flags: IR, Group: menuIcons */
		readonly iconWidth?: number; // Flags=IR
		 ...
		 * Flags: IR */
		readonly canSelectParent?: boolean; // Flags=IR
		/** (Read only) The text displayed for the menu item
		 * Flags: IR, Group: menuBasic */
		readonly title?: string /* HTML */; // Flags=IR
		 ...
		 * Flags: IR, Group: menuBasic */
		readonly enabled?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR, Group: menuBasic */
		readonly isSeparator?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR, Group: menuBasic */
		readonly embeddedComponent?: Canvas; // Flags=IR
		 ...
		 * Flags: IR, Group: menuIcons */
		readonly iconHeight?: number; // Flags=IR
		 ...
		 * Flags: IR, Group: menuBasic */
		readonly submenu?: Menu; // Flags=IR
		 ...
		 * Flags: IR, Group: menuKeys */
		readonly keys?: Array<string> /* KeyIdentifier | Array of KeyIdentifer */; // Flags=IR
		/** (Read only) When used in an AdaptiveMenu, should this MenuItem show only it's MenuItem.icon','icon when displayed inline?
		 * Flags: IR */
		readonly showIconOnlyInline?: boolean; // Flags=IR
		 ...
		 * Flags: IR, Group: menuBasic */
		readonly embeddedComponentPosition?: EmbeddedPosition; // Flags=IR
	}
	...
	export interface HeaderSpan  {
		 ...
		 * Flags: IR, Group: headerSpan */
		readonly fields?: Array<string> /* Array of String */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly wrap?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR, Group: headerSpan */
		readonly spans?: Array<HeaderSpan> /* Array of HeaderSpan */; // Flags=IR
		/** (Read only) Height of this headerSpan. Defaults to ListGrid.headerSpanHeight.
		 * Flags: IR, Group: headerSpan */
		readonly height?: number /* integer */; // Flags=IR
		 ...
		 * Flags: IR, Group: headerSpan */
		readonly headerTitle?: string /* String */; // Flags=IR
		 ...
		 * Flags: IR, Group: headerSpan */
		readonly valign?: VerticalAlignment; // Flags=IR
		/** (Read only) Horizontal alignment of the title of this headerSpan.
		 * Flags: IR, Group: headerSpan */
		readonly align?: Alignment; // Flags=IR
	}
	...
	export interface UserFormula  {
		 ...
		 * Flags: IR */
		readonly formulaVars?: any /* Map */; // Flags=IR
	}
	...
	export interface ListGridRecord  extends Record {
		...
		readonly backgroundComponent?: Canvas; // Flags=IR
		 ...
		 * Flags: IR */
		readonly canSelect?: boolean; // Flags=IR
		...
		readonly _canEdit?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly enabled?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly isSeparator?: boolean; // Flags=IR
		 ...
		 * Flags: IR, Group: appearance */
		readonly showRollOver?: boolean /* Boolean */; // Flags=IR
		...
		readonly canExpand?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly canAcceptDrop?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly canDrag?: boolean; // Flags=IR
	}
	...
	export interface Criterion  {
		 ...
		 * Flags: IR, Group: advancedFilter */
		readonly criteria?: Array<Criterion> /* Array of Criterion */; // Flags=IR
	...
	export interface ListGridField  {
		 ...
		 * Flags: IR */
		readonly canAutoFitWidth?: boolean /* Boolean */; // Flags=IR
		...
		readonly groupingMode?: string /* identifier */; // Flags=IR
		 ...
		 * Flags: IR, Group: grouping */
		readonly defaultGroupingMode?: string /* identifier */; // Flags=IR
		 ...
		 * Flags: IR, Group: appearance */
		readonly type?: ListGridFieldType; // Flags=IR
		 ...
		 * Flags: IR, Group: appearance */
		readonly headerTitle?: string; // Flags=IR
		 ...
		 * Flags: IR */
		readonly includeInRecordSummaryFields?: Array<string> /* array of fieldNames */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly canDragResize?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly formatGroupSummary?: string /* stringMethod */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly showGridSummary?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly includeInRecordSummary?: boolean; // Flags=IR
		 ...
		 * Flags: IR, Group: grouping */
		readonly groupGranularity?: number /* integer */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly filterOperator?: OperatorId; // Flags=IR
		...
		readonly canFreeze?: boolean; // Flags=IR
		 ...
		 * Flags: IR, Group: frozenFields */
		readonly frozen?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly hiliteHTMLAfterFormat?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR, Group: grouping */
		readonly groupingModes?: ValueMap; // Flags=IR
		 ...
		 * Flags: IR, Group: appearance */
		readonly canHide?: boolean; // Flags=IR
		...
		readonly autoFitWidth?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly prompt?: string /* HTMLString */; // Flags=IR
		 ...
		 * Flags: R */
		readonly operator?: string /* String */; // Flags=R
		 ...
		 * Flags: IR */
		readonly summaryFunction?: Array<SummaryFunction> /* SummaryFunction  or Array of SummaryFunction */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly iconSize?: number /* integer */; // Flags=IR
		/** (Read only) If this field is editable, this property will be passed to editors displayed for cells within this field as FormItem.defaultIconSrc.
		 * Flags: IRA, Group: editing */
		readonly defaultIconSrc?: string; // Flags=IRA
		 ...
		 * Flags: IR */
		readonly formatGridSummary?: string /* stringMethod */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly recordSummaryFunction?: RecordSummaryFunction; // Flags=IR
		 ...
		 * Flags: IR, Group: grouping */
		readonly groupPrecision?: number /* integer */; // Flags=IR
		 ...
		 * Flags: IR, Group: frozenFields */
		readonly autoFreeze?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly editorTextFormula?: UserSummary; // Flags=IR
		...
		/** (Read only) If set to true and ListGrid.canRemoveRecords is true, this field will be rendered as the remove-field for this grid. In most common usage scenarios this field will essentially be a placeholder indicating where the remove field should be rendered, meaning properties other than isRemoveField, such as name or title, may be left unset.
		 * Flags: IRA */
		readonly isRemoveField?: boolean; // Flags=IRA
		 ...
		 * Flags: IR */
		readonly canEditSummary?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly showGroupSummary?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly editorFormula?: UserFormula; // Flags=IR
		 ...
		 * Flags: IR, Group: editing */
		readonly initialValue?: any; // Flags=IR
		 ...
		 * Flags: IR */
		readonly partialSummary?: boolean; // Flags=IR
		 ...
		 * Flags: IR */
		readonly canEditFormula?: boolean /* Boolean */; // Flags=IR
		...
		/** (Read only) If this field is editable, this property will be passed to editors displayed for cells within this field as FormItem.iconVAlign.
		 * Flags: IRA, Group: editing */
		readonly iconVAlign?: string; // Flags=IRA
		 ...
		 * Flags: IR */
		readonly cellIcon?: string /* SCImgURL */; // Flags=IR
		...
		/** (Read only) If this field is editable, this property can be used to specify FormItem.icons','icons to be displayed in the editors displayed for this field
		 * Flags: IRA, Group: editing */
		readonly icons?: Array<FormItemIcon> /* Array of FormItemIcon Properties */; // Flags=IRA
		...
		/** (Read only) If this field is editable, this property will be passed to editors displayed for cells within this field as FormItem.iconHeight. If this property unset, the iconHeight property from the editor can be picked up from ListGridField.iconHeight instead.
		 * Flags: IRA, Group: editing */
		readonly editorIconHeight?: number; // Flags=IRA
		/** (Read only) If this field is editable, this property will be passed to editors displayed for cells within this field as FormItem.iconWidth. If this property unset, the iconWidth property from the editor can be picked up from ListGridField.iconWidth instead.
		 * Flags: IRA, Group: editing */
		readonly editorIconWidth?: number; // Flags=IRA
		 ...
		 * Flags: IR */
		readonly canReorder?: boolean; // Flags=IR
		 ...
		 * Flags: IR, Group: autoFitFields */
		readonly defaultWidth?: number /* Integer */; // Flags=IR
		 ...
		 * Flags: IR, Group: display_values */
		readonly optionFilterContext?: DSRequestProps /* DSRequest Properties */; // Flags=IR
		...
		/** (Read only) dataPath for this field. This property allows the grid to display details of nested data structures in a flat list of columns.
		 * Flags: IRA, Group: data */
		readonly dataPath?: string; // Flags=IRA
		 ...
		 * Flags: IR, Group: display_values */
		readonly optionTextMatchStyle?: TextMatchStyle; // Flags=IR
	...
	export interface TreeNode  {
		 ...
		 * Flags: IR */
		readonly isFolder?: boolean | string /* Boolean or String */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly title?: string /* HTML */; // Flags=IR
		/** (Read only) Governs whether dragged data (typically other treeNodes) may be dropped over this node. Only has an effect if this node is displayed in a TreeGrid where TreeGrid.canAcceptDroppedRecords, TreeGrid.canReorderRecords or TreeGrid.canReparentNodes is true.
		 * Flags: IRA */
		readonly canAcceptDrop?: boolean; // Flags=IRA
		/** (Read only) Default property name denoting whether this record is enabled. Property name may be modified for some grid via ListGrid.recordEnabledProperty.
		 * Flags: IR */
		readonly enabled?: boolean; // Flags=IR
		/** (Read only) Governs whether this node can be dragged. Only has an effect if this node is displayed in a TreeGrid where TreeGrid.canDragRecordsOut, TreeGrid.canReorderRecords or TreeGrid.canReparentNodes is true.
		 * Flags: IRA */
		readonly canDrag?: boolean; // Flags=IRA
		 ...
		 * Flags: IR */
		readonly parentId?: string | number /* String or Number */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly id?: string | number /* String or Number */; // Flags=IR
	}
	...
	export interface StretchItem  {
		 ...
		 * Flags: IR */
		readonly height?: number | string /* number or String */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly width?: number | string /* number or String */; // Flags=IR
	}
	...
	export interface DetailViewerField  {
		 ...
		 * Flags: IR */
		readonly valueMap?: any /* object */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly escapeHTML?: boolean; // Flags=IR
		/** (Read only) Dictates whether the data in this field be exported. Explicitly set this to false to prevent exporting. Has no effect if the underlying DataSourceField.canExport','dataSourceField is explicitly set to canExport: false.
		 * Flags: IR */
		readonly canExport?: boolean /* Boolean */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly type?: string /* String */; // Flags=IR
		 ...
		 * Flags: IR, Group: exportFormatting */
		readonly exportFormat?: string /* FormatString */; // Flags=IR
		/** (Read only) dataPath property allows this field to display detail from nested data structures
		 * Flags: IRA */
		readonly dataPath?: string /* String */; // Flags=IRA
		 ...
		 * Flags: IR */
		readonly value?: string /* HTMLString */; // Flags=IR
		 ...
		 * Flags: IR, Group: appearance */
		readonly emptyCellValue?: string /* HTMLString */; // Flags=IR
	...
	export interface Tab  {
		 ...
		 * Flags: IR */
		readonly canReorder?: boolean /* Boolean */; // Flags=IR
	...
	export interface UserSummary  {
		 ...
		 * Flags: IR */
		readonly summaryVars?: any /* Map */; // Flags=IR
	}
	...
	export interface PaletteNode  {
		 ...
		 * Flags: IR */
		readonly editNodeProperties?: EditNode /* EditNode Properties */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly idPrefix?: string /* String */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly canDuplicate?: boolean /* Boolean */; // Flags=IR
	}
	...
	export interface FormItemIcon  {
		/** (Read only) TabIndex for this formItemIcon. Set to -1 to remove the icon from the tab order, but be cautious doing so: if the icon triggers important application functionality that cannot otherwise be accessed via the keyboard, it would be a violation of accessibility standard to remove the icon from the tab order. Any usage other than setting to -1 is extremely advanced in the same way as using FormItem.globalTabIndex.
		 * Flags: IRA, Group: formIcons */
		readonly tabIndex?: number /* int */; // Flags=IRA
		...
		readonly hspace?: number /* Integer */; // Flags=IR
		 ...
		 * Flags: IR */
		readonly inlineIconAlign?: Alignment; // Flags=IR
		 ...
		 * Flags: IR */
		readonly inline?: boolean /* Boolean */; // Flags=IR
		...
		/** (Read only) Should this icon's FormItemIcon.src','src and/or FormItemIcon.baseStyle','baseStyle switch to the appropriate RTL value when the FormItem is in RTL mode? If true, then the image URL for all states will have "_rtl" added before the extension. Also, if baseStyle is set, all style names will have an "RTL" suffix. This should only be enabled if RTL media is available. For example, if an icon's src is "[SKINIMG]formItemIcons/myFormIcon.png" and the baseStyle is "myFormIcon", then in the "Down" state, SmartClient will use "[SKINIMG]formItemIcons/myFormIcon_Down_rtl.png" for the image source and "myFormIconDownRTL" for the style name.
		 * Flags: IRA, Group: RTL */
		readonly showRTL?: boolean /* Boolean */; // Flags=IRA
