...
declare namespace Isc {
    ...
    export interface iscStatic {
		 ...
		 */ 
		BaseWidget: BaseWidgetStatic<BaseWidget, BaseWidgetProperties>;
		 ...
		 */ 
		Canvas: CanvasStatic<Canvas, CanvasProperties>;
		 ...
		 */ 
		Class: ClassStatic<Class, ClassProperties>;
		 ...
		 */ 
		DataSource: DataSourceStatic<DataSource, DataSourceProperties>;

		/** 
		 * DetailViewer extends Canvas
		 * Displays one or more records "horizontally" with one property per line.
		 */ 
		DetailViewer: DetailViewerStatic<DetailViewer, DetailViewerProperties>;
		 ...
		 */ 
		Dialog: DialogStatic<Dialog, DialogProperties>;
		 ...
		 */ 
		DSRequest: DSRequestStatic<DSRequest, DSRequestProperties>;
		 ...
		 */ 
		DynamicForm: DynamicFormStatic<DynamicForm, DynamicFormProperties>;
		 ...
		 */ 
		FormItem: FormItemStatic<FormItem, FormItemProperties>;
		 ...
		 */ 
		HiliteEditor: HiliteEditorStatic<HiliteEditor, HiliteEditorProperties>;
		 ...
		 */ 
		HLayout: HLayoutStatic<HLayout, HLayoutProperties>;
		 ...
		 */ 
		HTMLFlow: HTMLFlowStatic<HTMLFlow, HTMLFlowProperties>;
		 ...
		 */ 
		Label: LabelStatic<Label, LabelProperties>;
		 ...
		 */ 
		Layout: LayoutStatic<Layout, LayoutProperties>;
		 ...
		 */ 
		LayoutSpacer: LayoutSpacerStatic<LayoutSpacer, LayoutSpacerProperties>;
		 ...
		 */ 
		ListGrid: ListGridStatic<ListGrid, ListGridProperties>;
		 ...
		 */ 
		Menu: MenuStatic<Menu, MenuProperties>;
		 ...
		 */ 
		MultiSortDialog: MultiSortDialogStatic<MultiSortDialog, MultiSortDialogProperties>;
		 ...
		 */ 
		NavigationBar: NavigationBarStatic<NavigationBar, NavigationBarProperties>;

		/** 
		 * NavigationButton extends Button
		 * Specially styled Button subclass used by the NavigationBar class.
		 */ 
		NavigationButton: NavigationButtonStatic<NavigationButton, NavigationButtonProperties>;
		 ...
		 */ 
		Page: PageStatic<Page, PageProperties>;
		 ...
		 */ 
		RestDataSource: RestDataSourceStatic<RestDataSource, RestDataSourceProperties>;
		 ...
		 */ 
		ResultSet: ResultSetStatic<ResultSet, ResultSetProperties>;
		 ...
		 */ 
		RPCRequest: RPCRequestStatic<RPCRequest, RPCRequestProperties>;
		 ...
		 */ 
		RPCResponse: RPCResponseStatic<RPCResponse, RPCResponseProperties>;
		 ...
		 */ 
		SearchForm: SearchFormStatic<SearchForm, SearchFormProperties>;
		 ...
		 */ 
		SectionStack: SectionStackStatic<SectionStack, SectionStackProperties>;
		 ...
		 */ 
		SelectItem: SelectItemStatic<SelectItem, SelectItemProperties>;
		 ...
		 */ 
		StatefulCanvas: StatefulCanvasStatic<StatefulCanvas, StatefulCanvasProperties>;
		 ...
		 */ 
		StretchImg: StretchImgStatic<StretchImg, StretchImgProperties>;
		 ...
		 */ 
		TabSet: TabSetStatic<TabSet, TabSetProperties>;

		/** 
		 * TextAreaItem extends FormItem
		 * Class for editable multi-line text areas (uses HTML &lt;TEXTAREA&gt; object)
		 */ 
		TextAreaItem: TextAreaItemStatic<TextAreaItem, TextAreaItemProperties>;

		/** 
		 * TextItem extends FormItem
		 * FormItem for managing a text field.
		 */ 
		TextItem: TextItemStatic<TextItem, TextItemProperties>;
		 ...
		 */ 
		Time: TimeStatic<Time, TimeProperties>;
		 ...
		 */ 
		Toolbar: ToolbarStatic<Toolbar, ToolbarProperties>;
		 ...
		 */ 
		ToolStrip: ToolStripStatic<ToolStrip, ToolStripProperties>;
		 ...
		 */ 
		ToolStripButton: ToolStripButtonStatic<ToolStripButton, ToolStripButtonProperties>;
		 ...
		 */ 
		Tree: TreeStatic<Tree, TreeProperties>;
		 ...
		 */ 
		Validator: ValidatorStatic<Validator, ValidatorProperties>;
		 ...
		 */ 
		ValuesManager: ValuesManagerStatic<ValuesManager, ValuesManagerProperties>;
		 ...
		 */ 
		VLayout: VLayoutStatic<VLayout, VLayoutProperties>;
		 ...
		 */ 
		Window: WindowStatic<Window, WindowProperties>;
