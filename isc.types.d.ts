...
declare namespace Isc {
	...
	/**
	 * The types of custom query that can be handled by SmartClient's built-in "sql" and "hibernate" DataSources. Note, only applies to OperationBinding.operationType "custom".
	 */
	export type SQLType = 
	...
	/**
	 * The Velocity variable names of the "pieces" of SQL that SmartClient generates to form a complete fetch or update query. You can use these variables in you own custom queries and query clause overrides to build on the SmartClient functionality. See customQuerying for a full discussion.
	 */
