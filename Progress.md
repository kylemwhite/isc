...
|9|Arrays defined as 'Array of'|238|Since most arrays are described this way, this is assumed to be the 'correct' way.|
...
|6|Arrays defined as 'array' or 'Array'|10|Since most arrays are NOT described this way, this is assumed to be incorrect.|
|7|Method params with missing name|1|All parameters should have a name.|
|8|Method params missing type|1|All parameters should have a type.|
