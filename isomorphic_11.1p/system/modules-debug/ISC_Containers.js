...
/*
  ...
  Version v11.1p_2017-07-09/LGPL Development Only (2017-07-09)
...
if (window.isc && isc.version != "v11.1p_2017-07-09/LGPL Development Only" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v11.1p_2017-07-09/LGPL Development Only'. Mixing resources from different "
...
_adjustControlClipping : function (vertical) {
    ...
    if (vertical) {
        ...
        if (firstTab) {
            ...
            if (tb.getVisibleHeight() < minBarHeight) {
                this.placeControlLayout(this.getViewportHeight() - minBarHeight);
        ...
        if (firstTab) {
            ...
            if (tb.getVisibleWidth() < minBarWidth) {
                this.placeControlLayout(this.getViewportWidth() - minBarWidth);
